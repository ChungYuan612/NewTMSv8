...
enum ShopItem{
    ...
    OCHRE_FROGLIGHT(Material.OCHRE_FROGLIGHT, 1, 50,-1),
    PEARLESCENT_FROGLIGHT(Material.PEARLESCENT_FROGLIGHT, 1, 50,-1),
    VERDANT_FROGLIGHT(Material.VERDANT_FROGLIGHT, 1, 50,-1),
